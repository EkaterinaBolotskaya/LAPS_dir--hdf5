...
def LAPS_4_interactively_plot_timeseries(scdir, ts_dir, json, os, np):
    ...
    if 'project' in data['object']['experiment']['information']:
        print('Project:', data['object']['experiment']['information']['project'])
        p_name.append(data['object']['experiment']['information']['project']+', ')
    else:
        print('No project description')
    if 'name' in data['object']['system']['apparatus']:
        print('Apparatus:', data['object']['system']['apparatus']['name'])
        p_name.append(data['object']['system']['apparatus']['name'])
    else:
        print('No apparatus name')
    if 'name' in data['object']['sample']['description']:
        print('Sample:', data['object']['sample']['description']['name'])
    else:
    ...
    if 'datasets' in data['object']['data']:
        print('Datasets:')
        for item in data['object']['data']['datasets']:
            print('   ', item['data'])
